...
kbdcfg.layout = { "us", "ru", } -- { { "us", "" , "Foo" }, { "us", "dvorak" , "Bar" } }
...
mytextclock = awful.widget.textclock(" %d/%m(%a) %H:%M:%S ", 1)
...
awful.rules.rules = {
    ...
    { rule = { class = "Sylpheed" }, properties = { tag = tags[1][7] }, maximized_vertical = true, maximized_horizontal = true  },
}
-- }}}
...
run_once("gtk-theme-switch", "/usr/share/themes/Adwaita");
run_once("conky", "-b")
